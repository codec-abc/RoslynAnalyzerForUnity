...
public class NoNotNullAttributeForSerializeFieldTests : BaseCodeFixVerifierTest<NoNullabilityAttribute, NoNullabilityAttributeCodeFix>
{
	[Fact]
...
";
		...
		var diagnostic = ExpectDiagnostic(NoNullabilityAttribute.Rule.Id)
			.WithLocation(6, 5)
